...
BETTER_RULES[0]="下列的图像变换为：将人脸的眼睛由闭合转换为睁开。<br>请从选项中选择转换更为成功的、看起来更为逼真的、与原图像色彩差异较小的结果。"
BETTER_RULES[1]="下列的图像变换为：将人脸由不笑转换为笑。<br>请从选项中选择转换更为成功的、看起来更为逼真的、与原图像色彩差异较小的结果。"
