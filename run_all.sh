...
DATA_DIRS=("hand_pick_celeba_close" "hand_pick_celeba_smile" "hand_pick_download_close" "hand_pick_download_smile" "hand_pick_eval_gt_our" "hand_pick_eval_gt_cyclegan" "hand_pick_eval_gt_residual" "hand_pick_eval_gt_idgan")
